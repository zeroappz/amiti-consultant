                                            ...
                                            <div class="tab-btn-box">
                                                <ul class="tab-btns tab-buttons clearfix">
                                                    <li class="tab-btn active-btn" data-tab="#tab-1">
                                                        <div class="icon-box"><i class="flaticon-checkmark" style="color: white;"></i></div>
                                                        <h6>Tech Solution</h6>
                                                    </li>
                                                ...
                                                <div class="tab active-tab" id="tab-1">
                                                  <!--   <div class="inner-box">
                                                       <figure class="image-box"><img src="assets/images/service/details-2.jpg" alt=""></figure>-->
                                                        <div class="text">
                                                        <p style="text-align:justify;padding-top:25px;">Amiti Corp is a high-performance technology solutions company focusing on engineering and information technology. We understand our clients’ critical business objectives and provide the best available resources while delivering unmatched value and services throughout the relationship and beyond.</p>
...
-->
                            ...
                            <!-------------------------------------Service Advantages----------------------------------------------->
                          <div id="listItem" class="content-four" style="position:relative; width: 100%;">
                                <!--       <div class="upper-box">
...
listItem(x) // Call listener function at run time
x.addListener(listItem)


$(document).ready(function() { 
    $("#cloud").click(function() {
           window.location.replace("cloud.php");
    });
    $("#aws").click(function() {
           window.location.replace("aws.php");
    });
    ...
    $("#cyber").click(function() {
           window.location.replace("cyber.php");
    });
    $("#digital").click(function() {
           window.location.replace("digital.php");
    });
