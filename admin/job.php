					...
					<div class="panel-heading">
						<div class="row">
							<div class="col-md-2" style="text-align:left;">
								<a href="add_jobs.php" class="btn btn-default btn-xs">Add New</a>				
							</div>
						</div>
					</div>
					<table id="jobsList" class="table table-bordered table-striped">
						<thead>
							<tr>
                                <th>Title</th>
                                <th>Role</th>
								<th>Description</th>
								<th>Salary <sub>per Annum</sub></th>
								<th>Experience <sub>in Yrs</sub></th>	
								<th>Edit</th>
								<th>Delete</th>	
							</tr>
						</thead>
