            ...
            <div class="auto-container">
                ...
                <div class="clients-inner">
                    <div class="clients-carousel-2 owl-carousel owl-theme owl-dots-none">
                        ...
                        <figure class="clients-logo-box">
                            <a href="index-2.html"><img src="assets/images/clients/22.png" alt=""></a>
                        </figure>
                        <figure class="clients-logo-box">
                            <a href="index-2.html"><img src="assets/images/clients/19.png" alt=""></a>
                        </figure>
            ...
            <div class="auto-container">
                <div class="row clearfix">
                        ...
                        <div class="testimonial-block-three">
                            <div class="inner-box">
                                ...
                                <div class="author-box">
                                    <figure class="author-thumb" style="padding-bottom: 10px ;"><img src="assets/images/resource/profile.png" alt=""></figure>
                                 <!--     <h3>Evan Clement</h3>-->
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 testimonial-block">
                        <div class="testimonial-block-three">
                            <div class="inner-box">
                                <div class="border-shap" style="background-image: url(assets/images/shape/border-3.png);"></div>
                                <figure class="quote-box"><img src="assets/images/icons/quote-3.png" alt=""></figure>
                                <div class="author-box">
                                ...
                                <div class="text">
                                    <p>Eazy Recruitz Services has been an enormous help to me by continuing to support my company’s Human Resources Department with qualified candidates.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12 testimonial-block">
                        <div class="testimonial-block-three">
                            <div class="inner-box">
                                <div class="border-shap" style="background-image: url(assets/images/shape/border-4.png);"></div>
                                <figure class="quote-box"><img src="assets/images/icons/quote-3.png" alt=""></figure>
                                <div class="author-box">
                                    <figure class="author-thumb" style="padding-bottom: 5px ;"><img src="assets/images/resource/profile.png" alt=""></figure>
                                    <h3>Ivor Hector</h3>
                                ...
                                <div class="text">
                                    <p>Thank you for the exceptional work in assisting us with our temporary positions. Eazy Recruitz outstanding follow-through during entire process. Extremely expedient in finding us the best qualified candidates.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 testimonial-block">
                        <div class="testimonial-block-three">
                            <div class="inner-box">
                                ...
                                <div class="text">
                                    <p>They are very helpful and have a heart to assist the business. I’ve been very pleased with the cooperation & assistance from Eazy Recruitz.</p>
                                </div>
                            </div>
                        </div>
                    </div>
