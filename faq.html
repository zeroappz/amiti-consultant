            ...
            <div class="auto-container">
                <div class="row clearfix">
                    <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                        <figure class="image-box"><img src="assets/images/resource/faq-1.png" alt=""></figure>
                    </div>
                            ...
                            <ul class="accordion-box">
                                ...
                                <li class="accordion block active-block">
                                    <div class="acc-btn active">
                                        <div class="icon-outer"></div>
                                        <h5>02. Where can I submit my resume?</h5>
                                    </div>
                                ...
                                <li class="accordion block">
                                    <div class="acc-btn">
                                        <div class="icon-outer"></div>
                                        <h5>03.What is the hiring process?</h5>
                                    </div>
                                    <div class="acc-content">
                                        <div class="text">
                                ...
                                <li class="accordion block">
                                    <div class="acc-btn">
                                        <div class="icon-outer"></div>
                                        <h5>04. Who can I contact, if I have any specific questions?</h5>
                                    </div>
                                    <div class="acc-content">
                                        <div class="text">
                                ...
                                <li class="accordion block">
                                    <div class="acc-btn">
                                        <div class="icon-outer"></div>
                                        <h5>05. Will my resume be sent to potential companies without my knowledge?</h5>
                                    </div>
                                    <div class="acc-content">
                                        <div class="text">
                                            <p>No, your resume will not be submitted to any client without your approval.</p>
                                        </div>
                                    </div>
                                </li>
