                ...
                <div class="row clearfix">
                    <div class="col-lg-8 col-md-12 col-sm-12 content-side">
                        <div class="service-details-content">
                                            ...
                                            <div class="tabs-content">
                                                <div class="tab active-tab" id="tab-1">
                                                    <div class="inner-box">
                                                        ...
                                                        <div class="text">
                                                            <h5 style="color:white;">- Legacy System Maintenance and Migration</h3>
                                                                <h5 style="color:white;">- Web Portal / Intranet / E-Business Solutions</h3>
                                                                    <h5 style="color:white;">- Production Support, Testing and QA</h3>
                                                                        <h5 style="color:white;">- Help Desk</h3>
                                                                            <h5 style="color:white;">- Business Process Outsourcing</h5>
                            ...
                            AMITI has a capable offshore development model creating economies of scale, which ensures that the solutions provided incorporate the current technologies and tools, with low cost burden to our customers. Our Project Managers and skilled Technical Architects
                            interface with our customers in generating the necessary strategies and specifications. Our variety of Offshore Services include: Legacy System Maintenance and Migration Web Portal / Intranet / E-Business Solutions Production
                            Support, Testing and QA Help Desk Business Process Outsourcing
                        ...
                        <div class="service-sidebar">
                            <div class="sidebar-widget categories-widget">
                                <ul class="categories-list clearfix">
                                    ...
                                    <li><a href="offshore.html" class="active" style="font-size: 15px;">OFFSHORE SERVICES</a></li>
