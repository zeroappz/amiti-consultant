                                            ...
                                            <div class="tabs-content">
                                                <div class="tab active-tab" id="tab-1">
                                                    <div class="inner-box">
                                                        ...
                                                        <div class="text">
                                                            <h5 style="color:white;">Project/Program management</h3>
                                                                <h5 style="color:white;">Risk and strategy</h3>
                                                                    <h5 style="color:white;">IT infrastructure</h3>
                                                                        <h5 style="color:white;">IT training</h3>
                        ...
                        <div class="service-sidebar">
                            <div class="sidebar-widget categories-widget">
                                <ul class="categories-list clearfix">
                                    <li><a href="itconsult.html" class="active" style="font-size: 15px;">IT CONSULTING</a></li>
