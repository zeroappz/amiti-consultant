        ...
        <section class="team-style-three">
            <div class="auto-container">
                <div class="sec-title centred">
                    <span class="top-title">Our Key Peoples</span>
                    ...
                    <div class="team-block-one">
                        <div class="inner-box">
                            <figure class="image-box">
                                ...
                                <span class="singature" style="color:#87CEFA;">Raj</span>
                                <div class="share-box">
                    ...
                    <div class="team-block-one">
                        <div class="inner-box">
                            <figure class="image-box">
                                ...
                                <span class="singature" style="color:#87CEFA;">Swapna</span>
                                <div class="share-box">
                                    <p><i class="fas fa-share-alt"></i>Share</p>
                                    <ul class="social-links clearfix">
                                        <li><a href="index-2.html"><i class="fab fa-facebook-f"></i></a></li>
                    ...
                    <div class="team-block-one">
                        <div class="inner-box">
                            <figure class="image-box">
                                ...
                                <span class="singature" style="color:#87CEFA;">Vikrant</span>
                                <div class="share-box">
                                    <p><i class="fas fa-share-alt"></i>Share</p>
                                    <ul class="social-links clearfix">
                                        <li><a href="index-2.html"><i class="fab fa-facebook-f"></i></a></li>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 team-block">
                        <div class="team-block-one wow fadeInUp animated animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                ...
                                <div class="lower-content">
                                    <h3><a href="index-2.html">Garrett Barnie</a></h3>
                                    <span class="designation">Founder</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 team-block">
                        <div class="team-block-one wow fadeInUp animated animated" data-wow-delay="200ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                ...
                                <div class="lower-content">
                                    <h3><a href="index-2.html">Joel Lou</a></h3>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 team-block">
                        <div class="team-block-one wow fadeInUp animated animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                ...
                                <div class="lower-content">
                                    <h3><a href="index-2.html">Isaac Herman</a></h3>
                                    <span class="designation">Consultant</span>
                                </div>
                            </div>
                        </div>
